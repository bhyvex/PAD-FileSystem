...
public class testHasher {
    ...
    public void testOneServer(){
        Hasher<Node,MsgData> hasher = new Hasher<>(
                1,
                iHasher.SHA1,
                iHasher.getNodeToBytesConverter(),
                iHasher.getDataToBytesConverter()
        );
        ...
        try {
            MsgData d = new MsgData<String>("AAAA","first data");
            MsgData d2 = new MsgData<String>("ZZZZ","second data");

            Assert.assertEquals(hasher.getServerForData(d),hasher.getServerForData(d2));
    ...
    public void testMoreServer(){
        ...
        try {
            MsgData d = new MsgData("AAAA","first data");
            Node n = hasher.getServerForData(d);
            //System.out.print(n);
            Assert.assertEquals(n,n3);

            MsgData d2 = new MsgData("BBBB","second data");
