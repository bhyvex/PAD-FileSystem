...
public class testHasher {
    ...
    public void testOneServer(){
        Hasher<Node,AppPayload> hasher = new Hasher<>(1,iHasher.SHA1,iHasher.getNodeToBytesConverter());
        ...
        try {
            AppPayload d = new AppPayload<String>("AAAA","first data");
            AppPayload d2 = new AppPayload<String>("ZZZZ","second data");
    ...
    public void testMoreServer(){
        ...
        try {
            AppPayload d = new AppPayload("AAAA","first data");
            Node n = hasher.getServerForData(d);
            //System.out.print(n);
            Assert.assertEquals(n,n3);

            AppPayload d2 = new AppPayload("BBBB","second data");
    ...
    public void testMoreVirtualServer(){
        Hasher<Node,AppPayload> hasher = new Hasher<>(
                3,
                iHasher.SHA1,
